...
const Header = () => {
  return (
    <header className="p-(--pad-phone) flex items-center justify-between w-full md:px-(--pad-desk) sticky top-0">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <h1 className="font-semibold text-(--clr-text-primary) text-lg leading-5">
            Dashboard
          </h1>
        </div>
      </div>
